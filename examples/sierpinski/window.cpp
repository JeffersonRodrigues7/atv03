...
void Window::onPaintUI() {
...

  {
    ...
    ImGui::SliderInt("##01", &slider01, 0, 100);
    if (ImGui::SliderInt("##02", &slider02, 0, 100)) {
      if ((slider01 + slider02 + slider03) > 100) {
        if (slider02 % 2 == 0) {
          slider01--;
        } else {
          slider03--;
        }
      } else if ((slider01 + slider02 + slider03) < 100) {
        if (slider02 % 2 == 0) {
          slider01++;
        } else {
          slider03++;
    ...
    ImGui::SliderInt("##03", &slider03, 0, 100);
